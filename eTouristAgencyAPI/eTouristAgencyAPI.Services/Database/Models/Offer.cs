...
public partial class Offer
{
    ...
    [NotMapped] public bool IsLastMinuteDiscountActive { get; set; }

    [NotMapped] public bool IsFirstMinuteDiscountActive { get; set; }

    [NotMapped] public decimal MinimumPricePerPerson { get; set; }

    [NotMapped] public int RemainingSpots { get; set; }
}
