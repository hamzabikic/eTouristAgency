...
class VerificationCodeProvider {
  ...
  Future addEmailVerification () async {
    ...
    if(response.statusCode !=200){
      throw Exception("Dosegli ste limit. U 24 sata moguće je poslati maksimalno 5 puta zahtjev za verifikaciju.");
    }
  }
  ...
  Future<bool> resetPasswordVerificationCodeExists(String verificationKey) async{
    var url = Uri.parse("${_controllerUrl}/reset-password/exists?verificationKey=${verificationKey}");
